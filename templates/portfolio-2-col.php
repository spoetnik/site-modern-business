...
if($projects->count) {
    ...
    foreach($projects as $project){
        ...
        if($primaryimage) $primaryimageresized = $primaryimage->width(538);

        $projectblock .= "        <div class='col-lg-6 portfolio-item'>";
        ...
        $projectblock .= "            </h4>";
        $projectblock .= "            <p class='card-text'>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nam viverra euismod odio, gravida pellentesque urna varius vitae.</p>";
        $projectblock .= "          </div>";
        $projectblock .= "        </div>";
        $projectblock .= "      </div>";
     }
